...
const Toska_armchair = () => {
  ...
  const thumbnails = [
    'images/toskaarm2.png',
    'images/toskaarm3.png',
    'images/toskaarm4.png',
    'images/toskaarm5.png',
  ];
  ...
  return (
    <>
      ...
      <img src="images/toskaarm1.png" className="w-full rounded-lg main-image" alt="Product" />
      ...
      <div className="flex justify-between mt-4 space-x-4">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Toska ArmChair</h2>
          <h4 className="text-2xl font-semibold text-gray-700 mb-4">$350.00</h4>
          <select className="border p-2 my-2 rounded-md">
            <option value="">Select Texture</option>
            <option value="modern-blue">Red</option>
            <option value="glistening-red">Brown</option>
            <option value="stunning-green">Yellow</option>
            <option value="army-blue">Green</option>
            <option value="brown-sand">Blue</option>
          </select>
    ...
    />
      ...
      >
        Add to Cart
          ...
          <Link to = "/Toska_armchair" className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Try it Now!!</Link>
          </div>
          <h3 className="mt-4 text-2xl font-semibold">Product Details<i className="fa fa-indent ml-2"></i></h3>
          <br />
          <p className="text-gray-700">
          Elegant, sophisticated, and ergonomically designed, the Toska Armchair redefines the concept of seating with its exquisite blend of style and comfort. Featuring a harmonious interplay of round, soft, and sinuous shapes, this series of armchairs introduces a fresh perspective on relaxation. The color palette, along with innovative combinations of leather and fabric, offers a unique visual appeal. Horizontal and vertical surfaces engage in a captivating dialogue, creating a dynamic visual experience with subtle shades or bold contrasts.
          </p>
        </div>
      </div>
    </div>
