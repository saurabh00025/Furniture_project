...
const Antique_table = () => {
  ...
  return (
    <>
      ...
      <img src="images/antique1.png" className="w-full rounded-lg main-image" alt="Product" />
      ...
      <div className="flex justify-between mt-4 space-x-4">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Antique Table</h2>
          ...
          <select className="border p-2 my-2 rounded-md">
            ...
            <option value="glistening-red">Black</option>
            <option value="stunning-green">White</option>
            <option value="army-blue">Red</option>
    ...
    />
      ...
      >
        Add to Cart
          ...
          <Link to = "/Antique_table" className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Try it Now!!</Link>
          </div>
          <h3 className="mt-4 text-2xl font-semibold">Product Details<i className="fa fa-indent ml-2"></i></h3>
          <br />
          <p className="text-gray-700">
          Displaying a superb degree of artistry, this table exemplifies the historical era with grace and charm. Every element from upholstery to hardware served to unify the design of the room. The inset surface of this exquisite table features a stunning example of amethyst. Rich in Neoclassical elegance yet possessing an exotic worldliness.
          </p>
        </div>
      </div>
    </div>
