...
const Arm_chair = () => {
  ...
  const thumbnails = [
    'images/armchair2.png',
    'images/armchair3.png',
    'images/armchair4.png',
    'images/armchair5.png',
  ];
  ...
  return (
    <>
      ...
      <img src="images/armchair1.png" className="w-full rounded-lg main-image" alt="Product" />
